...
public class BarattopoliUtil {
    ...
    /**
     * a reference to the Firebase Auth
     */
    private static FirebaseAuth mAuth = FirebaseAuth.getInstance();
    /**
     * a basic image to use when another one is not available
     */
     ...
     */
    private static void mapChildren(String contextTag, DatabaseReference dbRef, Consumer<Map<String, String>> consumer) {
    ...
    /**
     * help populating an array with values fetched from the database and stored in a map
     * @param map the map with the correspondences between keys and values which have been fetched from the database
     * @param dataBaseKeyTag the node in the database where the data have been fetched previously
     * @param mainData the arrayList where to put the values
     * @param mainDataIndex the index to use in mainData
     */
     static void retrieveHelper(Map<String, Object> map, String dataBaseKeyTag, ArrayList<String> mainData, int mainDataIndex) {
    ...
    /**
     * convert a Bitmap image in a String.
     * @param bitmap the image provided
    ...
    /**
     * reconvert a previously converted image from a String
     * @param encodedImage the String with the encoded image
